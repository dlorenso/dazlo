...
class Daz_Config {
    ...
    public static function dump() {
        Daz_Debug :: dump(print_r(self :: $CONFIGS, true));
    }
    ...
    public static function init($env, $custom) {
        // sanity check
        if (!$env || !$custom) {
            throw new Daz_Exception('Invalid config file initialization parameters!');
        }
        ...
        self :: importConfig(Daz_String :: merge(self :: CONFIG_FILE_SERVER, $data));

        // import the ENV config settings
        self :: importConfig(Daz_String :: merge(self :: CONFIG_FILE_ENV, $data));

        // import the CUSTOM config settings
        self :: importConfig(Daz_String :: merge(self :: CONFIG_FILE_CUSTOM, $data));
